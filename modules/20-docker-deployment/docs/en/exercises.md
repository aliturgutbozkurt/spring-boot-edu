...
1. The starter code is in `modules/20-docker-deployment/exercise/`. Find the `TODO` comments.
...
5. If you get stuck, read the hints first, then the solution in `modules/20-docker-deployment/solution/`.
...
- `TODO 1` in `exercise/src/main/java/com/springbootedu/dockerdeployment/...` ...
