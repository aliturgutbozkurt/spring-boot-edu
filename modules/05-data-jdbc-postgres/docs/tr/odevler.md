...
1. Başlangıç kodu `modules/05-data-jdbc-postgres/exercise/` içindedir. `TODO` yorumlarını bulun.
...
- `exercise/src/main/java/com/springbootedu/datajdbcpostgres/...` içindeki `TODO 1` ...
