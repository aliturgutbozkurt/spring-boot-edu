...
1. The starter code is in `modules/05-data-jdbc-postgres/exercise/`. Find the `TODO` comments.
...
- `TODO 1` in `exercise/src/main/java/com/springbootedu/datajdbcpostgres/...` ...
