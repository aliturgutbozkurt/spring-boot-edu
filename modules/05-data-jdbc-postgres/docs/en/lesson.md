...
```bash
./mvnw -pl modules/05-data-jdbc-postgres/lesson spring-boot:run
```
...
<!-- snippet: lesson/src/main/java/com/springbootedu/datajdbcpostgres/DataJdbcPostgresApplication.java#application -->
```java
@SpringBootApplication
public class DataJdbcPostgresApplication {

    public static void main(String[] args) {
        SpringApplication.run(DataJdbcPostgresApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/datajdbcpostgres/ExampleTest.java`
