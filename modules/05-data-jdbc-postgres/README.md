...
./mvnw -pl modules/05-data-jdbc-postgres/lesson spring-boot:run -Dspring-boot.run.arguments=--spring.docker.compose.enabled=false

# Testler / Tests (Testcontainers)
./mvnw -pl modules/05-data-jdbc-postgres/lesson verify

# Ödevler / Exercises (kırmızı başlar / start red)
./mvnw -Pexercises -pl modules/05-data-jdbc-postgres/exercise test
```
