...
1. Başlangıç kodu `modules/18-modulith/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/18-modulith/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/modulith/...` içindeki `TODO 1` ...
