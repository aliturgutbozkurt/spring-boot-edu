...
<!-- snippet: lesson/src/main/java/com/springbootedu/modulith/ModulithApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/modulith/ExampleTest.java`
