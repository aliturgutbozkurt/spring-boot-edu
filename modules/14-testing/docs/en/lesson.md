...
<!-- snippet: lesson/src/main/java/com/springbootedu/testing/TestingApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/testing/ExampleTest.java`
