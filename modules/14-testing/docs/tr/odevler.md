...
1. Başlangıç kodu `modules/14-testing/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/14-testing/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/testing/...` içindeki `TODO 1` ...
