...
<!-- snippet: lesson/src/main/java/com/springbootedu/datajpapostgres/DataJpaPostgresApplication.java#application -->
```java
@SpringBootApplication
public class DataJpaPostgresApplication {

    public static void main(String[] args) {
        SpringApplication.run(DataJpaPostgresApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/datajpapostgres/ExampleTest.java`
