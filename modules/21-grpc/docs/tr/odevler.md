...
1. Başlangıç kodu `modules/21-grpc/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/21-grpc/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/grpc/...` içindeki `TODO 1` ...
