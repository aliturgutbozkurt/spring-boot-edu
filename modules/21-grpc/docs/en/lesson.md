...
<!-- snippet: lesson/src/main/java/com/springbootedu/grpc/GrpcApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/grpc/ExampleTest.java`
