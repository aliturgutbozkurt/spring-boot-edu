...
1. Başlangıç kodu `modules/16-async-scheduling-batch/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/16-async-scheduling-batch/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/asyncschedulingbatch/...` içindeki `TODO 1` ...
