...
<!-- snippet: lesson/src/main/java/com/springbootedu/asyncschedulingbatch/AsyncSchedulingBatchApplication.java#application -->
```java
@SpringBootApplication
public class AsyncSchedulingBatchApplication {

    public static void main(String[] args) {
        SpringApplication.run(AsyncSchedulingBatchApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/asyncschedulingbatch/ExampleTest.java`
