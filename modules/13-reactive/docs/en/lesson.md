...
<!-- snippet: lesson/src/main/java/com/springbootedu/reactive/ReactiveApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/reactive/ExampleTest.java`
