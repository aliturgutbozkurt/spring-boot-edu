...
<!-- snippet: lesson/src/main/java/com/springbootedu/elasticsearch/ElasticsearchApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/elasticsearch/ExampleTest.java`
