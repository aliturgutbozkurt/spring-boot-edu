# 01 · Spring Core Container: IoC ve Bağımlılık Enjeksiyonu / Spring Core Container: IoC and Dependency Injection
...
./mvnw -pl modules/01-core-container/lesson spring-boot:run -Dspring-boot.run.arguments=--spring.docker.compose.enabled=false
