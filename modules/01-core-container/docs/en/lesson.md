...
<!-- snippet: lesson/src/main/java/com/springbootedu/corecontainer/CoreContainerApplication.java#application -->
```java
@SpringBootApplication
public class CoreContainerApplication {

    public static void main(String[] args) {
        SpringApplication.run(CoreContainerApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/corecontainer/ExampleTest.java`
