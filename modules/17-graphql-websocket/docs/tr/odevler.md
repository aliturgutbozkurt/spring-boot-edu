...
1. Başlangıç kodu `modules/17-graphql-websocket/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/17-graphql-websocket/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/graphqlwebsocket/...` içindeki `TODO 1` ...
