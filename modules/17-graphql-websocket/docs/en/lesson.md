...
<!-- snippet: lesson/src/main/java/com/springbootedu/graphqlwebsocket/GraphqlWebsocketApplication.java#application -->
```java
@SpringBootApplication
public class GraphqlWebsocketApplication {

    public static void main(String[] args) {
        SpringApplication.run(GraphqlWebsocketApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/graphqlwebsocket/ExampleTest.java`
