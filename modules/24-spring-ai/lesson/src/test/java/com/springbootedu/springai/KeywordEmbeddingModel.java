...
/**
 * Lesson 3.8 — an EmbeddingModel for tests: one dimension per keyword. Texts that share keywords get similar
...
public class KeywordEmbeddingModel implements EmbeddingModel {
    ...
    public static final List<String> KEYWORDS = List.of(
            "java", "spring", "database", "distributed", "replication", "pattern", "design", "security",
            "rest", "stream", "concurrency", "beginner", "boot", "transaction", "web", "object");
