...
1. Başlangıç kodu `modules/08-redis-caching/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/08-redis-caching/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/rediscaching/...` içindeki `TODO 1` ...
