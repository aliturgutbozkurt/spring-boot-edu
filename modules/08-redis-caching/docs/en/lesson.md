...
<!-- snippet: lesson/src/main/java/com/springbootedu/rediscaching/RedisCachingApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/rediscaching/ExampleTest.java`
