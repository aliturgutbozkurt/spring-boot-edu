...
<!-- snippet: lesson/src/main/java/com/springbootedu/setupmodernjava/SetupModernJavaApplication.java#application -->
```java
@SpringBootApplication
public class SetupModernJavaApplication {

    public static void main(String[] args) {
        SpringApplication.run(SetupModernJavaApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/setupmodernjava/ExampleTest.java`
