...
1. Başlangıç kodu `modules/15-observability/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/15-observability/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/observability/...` içindeki `TODO 1` ...
