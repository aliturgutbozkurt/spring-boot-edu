...
<!-- snippet: lesson/src/main/java/com/springbootedu/springcloud/SpringCloudApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/springcloud/ExampleTest.java`
