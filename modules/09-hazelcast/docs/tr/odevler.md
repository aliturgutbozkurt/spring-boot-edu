...
1. Başlangıç kodu `modules/09-hazelcast/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/09-hazelcast/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/hazelcast/...` içindeki `TODO 1` ...
