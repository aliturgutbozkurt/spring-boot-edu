...
<!-- snippet: lesson/src/main/java/com/springbootedu/hazelcast/HazelcastApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/hazelcast/ExampleTest.java`
