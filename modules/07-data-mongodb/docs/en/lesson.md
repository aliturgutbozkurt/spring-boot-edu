...
<!-- snippet: lesson/src/main/java/com/springbootedu/datamongodb/DataMongodbApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/datamongodb/ExampleTest.java`
