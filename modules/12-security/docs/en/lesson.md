...
<!-- snippet: lesson/src/main/java/com/springbootedu/security/SecurityApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/security/ExampleTest.java`
