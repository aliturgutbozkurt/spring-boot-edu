...
1. Başlangıç kodu `modules/12-security/exercise/` içindedir. `TODO` yorumlarını bulun.
...
5. Takıldığınızda önce ipuçlarına, sonra `modules/12-security/solution/` içindeki çözüme bakın.
...
- `exercise/src/main/java/com/springbootedu/security/...` içindeki `TODO 1` ...
