...
<!-- snippet: lesson/src/main/java/com/springbootedu/kubernetes/KubernetesApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/kubernetes/ExampleTest.java`
