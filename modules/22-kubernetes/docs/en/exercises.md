...
1. The starter code is in `modules/22-kubernetes/exercise/`. Find the `TODO` comments.
...
5. If you get stuck, read the hints first, then the solution in `modules/22-kubernetes/solution/`.
...
- `TODO 1` in `exercise/src/main/java/com/springbootedu/kubernetes/...` ...
