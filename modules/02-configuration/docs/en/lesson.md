...
<!-- snippet: lesson/src/main/java/com/springbootedu/configuration/ConfigurationApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/configuration/ExampleTest.java`
