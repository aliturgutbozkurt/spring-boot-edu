...
<!-- snippet: lesson/src/main/java/com/springbootedu/httpclientsresilience/HttpClientsResilienceApplication.java#application -->
```java
@SpringBootApplication
public class HttpClientsResilienceApplication {

    public static void main(String[] args) {
        SpringApplication.run(HttpClientsResilienceApplication.class, args);
    }
}
```
...
**Its test:** `lesson/src/test/java/com/springbootedu/httpclientsresilience/ExampleTest.java`
