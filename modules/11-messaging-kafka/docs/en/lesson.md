...
<!-- snippet: lesson/src/main/java/com/springbootedu/messagingkafka/MessagingKafkaApplication.java#application -->
```java
...
**Its test:** `lesson/src/test/java/com/springbootedu/messagingkafka/ExampleTest.java`
