...
public class StockClient {
    ...
    @Retryable(includes = CatalogUnavailableException.class,   // UNAVAILABLE, DEADLINE_EXCEEDED — not "out of stock"
            maxRetries = 2, delay = 100, multiplier = 2)       // 1 call + 2 retries, ~100 ms and ~200 ms apart
