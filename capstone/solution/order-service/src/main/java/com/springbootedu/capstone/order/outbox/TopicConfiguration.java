...
import com.springbootedu.capstone.order.order.OrderCancelled;
...
class TopicConfiguration {
    ...
    @Bean
    NewTopic cancellationsTopic() {                                          // exercise 2
        return TopicBuilder.name(OrderCancelled.TOPIC).partitions(3).build();
    }
}
